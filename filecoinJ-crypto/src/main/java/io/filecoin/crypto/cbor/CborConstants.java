...
public interface CborConstants {
    ...
    int TRUE = 0x15;
    /**
     * The CBOR-encoded <code>null</code> value (encoded as "simple value": {@link #}).
     */
    int NULL = 0x16;
    /**
     * The CBOR-encoded "undefined" value (encoded as "simple value": {@link #}).
     */
    int UNDEFINED = 0x17;
    /**
     * Denotes a half-precision float (two-byte IEEE 754, see {@link #}).
     */
    int HALF_PRECISION_FLOAT = 0x19;
    /**
     * Denotes a single-precision float (four-byte IEEE 754, see {@link #}).
     */
    int SINGLE_PRECISION_FLOAT = 0x1a;
    /**
     * Denotes a double-precision float (eight-byte IEEE 754, see {@link #}).
     */
