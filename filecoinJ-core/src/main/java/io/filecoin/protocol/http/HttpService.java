package io.filecoin.protocol.http;


import io.filecoin.protocol.Service;
import io.filecoin.protocol.exceptions.ClientConnectionException;
import okhttp3.*;
...
public class HttpService extends Service {
    ...
    public static final String DEFAULT_URL = "http://localhost:1234/rpc/v0";
